...
the text encoder for a prompt $t$. A visible-key sentinel makes $x$ contain or
depict a rare key string. DeepSentinel instead constructs a sentinel $x_s$ that
satisfies:
\begin{align}
...
adversarial protection for diffusion models. This draft intentionally leaves
these related-work citations as \textbf{[CITATION NEEDED]} until they are
